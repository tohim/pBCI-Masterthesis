...
% % Path for wRef 24
% base_pipeline_path = fullfile('E:', 'SchuleJobAusbildung', 'HTW', 'MasterThesis', ...
%     'Code', 'Matlab', 'Data', 'LEGACY', 'proc3noAndwRef_24_AutoPipeline', 'noRef_AutoPipeline', 'v1');
% 
% base_calibration_path = fullfile('E:', 'SchuleJobAusbildung', 'HTW', 'MasterThesis', ...
%     'Code', 'Matlab', 'Data', 'LEGACY', 'proc3noAndwRef_24_AutoCalibration', 'noRef_AutoCalibration', 'v1');
...
%     calib_map('2000_25') = [350, 25];   calib_map('3000_10') = [210, 10];
%     calib_map('4000_10') = [280, 10];

    % Calibration sample mapping + percentage
    calib_map = containers.Map;
    calib_map('1000_30') = [210, 30];
